...
public class MainController {
    ...
    public String showCategories(Map<String, Object> model){
        ...
        Iterable<Category> categories = categoryRepo.findByNameCategory("Покупки");
    ...
    public String showTransactions(@AuthenticationPrincipal User user, Map<String, Object> model){
